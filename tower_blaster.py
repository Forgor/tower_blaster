...
def human_play(tower, main_pile, discard):
    ...
    pick = ask_user_input("m","d","TYPE 'm' for 'mystery pile', d for 'discard pile or 'h' for help.")
...
def print_final_results(winner,humans_hand,computers_hand):
    ...
    print("Your Tower: "+str(humans_hand))
...
def main():
    ...
    while(game_over==False):
        ...
        over=check_tower_blaster(humans_hand)
        if (over == True):
            winner = "human"
            break
